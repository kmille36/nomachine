...
RUN apt-get install -y software-properties-common firefox nano sudo && add-apt-repository ppa:leaeasy/dde && apt-get update &&  apt-get install dde dde-file-manager && apt install deepin-gtk-theme
